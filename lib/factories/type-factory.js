...
module.exports = class Type {
  getType(name, elem, inputFolder, outputFolder, options){
    return classes.hasOwnProperty(metadata[name].xmlName) ? new (classes[metadata[name].xmlName])(elem, inputFolder, outputFolder, options) : new Standard(elem, inputFolder, outputFolder, options);
  }
