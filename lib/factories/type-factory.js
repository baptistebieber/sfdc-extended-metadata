...
module.exports = class Type {
  getType(elem, inputFolder, outputFolder, options){
    return !!classes[metadata[elem.name].xmlName] ? new (classes[metadata[elem.name].xmlName])(elem, inputFolder, outputFolder, options) : new Standard(elem, inputFolder, outputFolder, options);
  }
};